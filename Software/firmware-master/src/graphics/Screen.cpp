...
void Screen::setup()
{
    ...
    // On some ssd1306 clones, the first dgetFromRadio=STATE_SEND_MODULECONFIGgetFromRadio=STATE_SEND_MODULECONFIGgetFromRadio=STATE_SEND_MODULECONFIGraw command is discarded, so draw it
